...
void ds1307_get_current_time(RTC_time_t *rtc_time) {
	...
	if(hrs & ( 1 << 6)) {
		...
		hrs &= ~(0x3 << 5); //clear 5th and 6th bit
	}else {
		//24 hr format
...
static void ds1307_i2c_pin_config(void) {
	...
	/*
	 * I2C1 peripheral pins
	 * SCL --> PB6
	 * SDA --> PB7
	 * ALTTERNATE FUNCTION MODE: 4
	 */
...
static void ds1307_i2c_config(void) {
	...
	g_ds1307I2CHandle.I2CConfig.I2C_SCLSpeed = DS1307_I2C_SPEED;
